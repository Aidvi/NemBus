...
public class DebugInterceptor implements Interceptor {
    ...
    private void printRequest(final Request request) {
        ...
        Log.d("DebugInterceptor", sb.toString());
    }
    ...
    private void printResponse(final Response response) {
        ...
        if (mPrintRequestBodyParamsInResponse != null) {
            try {
                ...
                Log.e("DebugInterceptor", e.getMessage());
            }
        }
        ...
        if (success) {
            ...
            Log.e("DebugInterceptor", sb.toString());
        }
    }
            ...
            if (body != null) {
                ...
                if (contentType != null) {
                    try {
                        ...
                        Log.e("DebugInterceptor", "Couldn't decode the response body; charset is likely malformed.");
                    }
                }
